...
entry:
  ...
  %".17" = bitcast [9 x i8]* @"str.3613693433752715259" to i8*
  %".18" = bitcast [12 x i8]* @"str.4412541974357060881" to i8*
  ...
  %".22" = bitcast [8 x i8]* @"str.-3497304727972985946" to i8*
  ...
  %".26" = bitcast [8 x i8]* @"str.5716946345836006802" to i8*
  ...
  %".32" = bitcast [20 x i8]* @"str.-4569468012284973367" to i8*
  ...
  %".37" = bitcast [3 x i8]* @"fmt_7450633905943628218" to i8*
  ...
  %"jean" = alloca i8*
  %".94" = bitcast [5 x i8]* @"str.-4727498176527571606" to i8*
  store i8* %".94", i8** %"jean"
  %"gg" = alloca double
  ...
  %".100" = bitcast [23 x i8]* @"str.-643552820027265896" to i8*
  %"gg.1" = load double, double* %"gg"
  %"strconv_buf.2" = alloca [32 x i8]
  %".101" = bitcast [32 x i8]* %"strconv_buf.2" to i8*
  %".102" = bitcast [3 x i8]* @"fmt_7450633905943628218" to i8*
  ...
  %".109" = bitcast [9 x i8]* @"str.-396560488125965123" to i8*
  %"strconv_buf.3" = alloca [32 x i8]
  %".110" = bitcast [32 x i8]* %"strconv_buf.3" to i8*
  %".111" = bitcast [3 x i8]* @"fmt_122684548135079981" to i8*
  ...
  %".118" = bitcast [18 x i8]* @"str.7352403852144901648" to i8*
  ...
  %".123" = bitcast [3 x i8]* @"fmt_7450633905943628218" to i8*
  ...
  %".161" = bitcast [24 x i8]* @"str.7291092878830289736" to i8*
  ...
  %".171" = bitcast [21 x i8]* @"str.8943300874301979134" to i8*
...
for.body.1:
  ...
  %".281" = bitcast [6 x i8]* @"str.7217103673683584462" to i8*
  %"i.3" = load i32, i32* %"i"
  %"strconv_buf.5" = alloca [32 x i8]
  %".282" = bitcast [32 x i8]* %"strconv_buf.5" to i8*
  %".283" = bitcast [3 x i8]* @"fmt_122684548135079981" to i8*
...
for.exit.1:
  ...
  store i32 5, i32* %"var"
  %"saludo" = alloca i8*
  %".355" = bitcast [12 x i8]* @"str.-2119849515522328904" to i8*
...
while.body:
  %".387" = bitcast [5 x i8]* @"str.-7234436746275970846" to i8*
...
for.exit.3:
  ...
  %".724" = bitcast [19 x i8]* @"str.7395103503712258414" to i8*
  ...
  %".730" = bitcast [2 x i8]* @"str.-3334893379800373686" to i8*
  ...
  %".787" = bitcast [24 x i8]* @"str.1587425158494560781" to i8*
...
then:
  %".855" = bitcast [7 x i8]* @"str.5848789806655200187" to i8*
  %".856" = bitcast [4 x i8]* @"fmt_string" to i8*
  %".857" = call i32 (i8*, ...) @"printf"(i8* %".856", i8* %".855")
  br label %"ifcont"
else:
  %".859" = bitcast [11 x i8]* @"str.4376633864494759195" to i8*
...
@"str.-3497304727972985946" = internal constant [8 x i8] c"Jean + \00"
@"str.5716946345836006802" = internal constant [8 x i8] c"Roberto\00"
@"str.-4569468012284973367" = internal constant [20 x i8] c"el res de 3^333 es \00"
@"fmt_float" = internal constant [4 x i8] c"%f\0a\00"
@"str.-4727498176527571606" = internal constant [5 x i8] c"hola\00"
...
@"str.5848789806655200187" = internal constant [7 x i8] c"x > 15\00"
