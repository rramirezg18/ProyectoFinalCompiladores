...
for.body:                                         ; preds = %entry, %for.body
  ...
  %.17 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_float, i64 0, i64 0), double 0x47311B0EC57E649A)
  %.19 = add nuw nsw i32 %i.01, 1
  %.9 = icmp ult i32 %i.01, 10000
