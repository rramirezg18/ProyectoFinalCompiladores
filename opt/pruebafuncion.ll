...
{
entry:
  %".2" = bitcast [5 x i8]* @"str.-3853744401923204774" to i8*
  %".3" = bitcast [4 x i8]* @"fmt_string" to i8*
  %".4" = call i32 (i8*, ...) @"printf"(i8* %".3", i8* %".2")
  %".5" = bitcast [15 x i8]* @"str.-9121464976246647715" to i8*
  %".6" = bitcast [4 x i8]* @"fmt_string" to i8*
  %".7" = call i32 (i8*, ...) @"printf"(i8* %".6", i8* %".5")
  %".8" = bitcast [4 x i8]* @"str.1120429162075801352" to i8*
  %".9" = bitcast [10 x i8]* @"str.-6629683823316762691" to i8*
...
entry:
  ...
  %".4" = bitcast [13 x i8]* @"str.-7167250634943350552" to i8*
  %"miEdad.1" = load i32, i32* %"miEdad"
  %"strconv_buf" = alloca [32 x i8]
  %".5" = bitcast [32 x i8]* %"strconv_buf" to i8*
  %".6" = bitcast [3 x i8]* @"fmt_1182425524083821122" to i8*
...
@"str.1120429162075801352" = internal constant [4 x i8] c"Soy\00"
