...
{
entry:
  %".2" = bitcast [21 x i8]* @"str.5510459803934402180" to i8*
...
for.exit:
  ...
  store i32 5, i32* %"var"
  %"saludo" = alloca i8*
  %".167" = bitcast [12 x i8]* @"str.-5039348181066730845" to i8*
...
while.body:
  %".199" = bitcast [5 x i8]* @"str.-5270465473217331310" to i8*
...
for.exit.2:
  ...
  %".437" = bitcast [19 x i8]* @"str.9007448794288354940" to i8*
  ...
  %".443" = bitcast [2 x i8]* @"str.7429974814908541414" to i8*
  ...
  %".451" = bitcast [24 x i8]* @"str.-1696583040775164703" to i8*
...
then:
  %".519" = bitcast [7 x i8]* @"str.-3814276296837737567" to i8*
  %".520" = bitcast [4 x i8]* @"fmt_string" to i8*
  %".521" = call i32 (i8*, ...) @"printf"(i8* %".520", i8* %".519")
  br label %"ifcont"
else:
  %".523" = bitcast [11 x i8]* @"str.-8500427329205055830" to i8*
