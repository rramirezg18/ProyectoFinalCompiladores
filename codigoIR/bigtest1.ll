...
entry:
  ...
  %".19" = bitcast [19 x i8]* @"str.9007448794288354940" to i8*
  ...
  %".25" = bitcast [2 x i8]* @"str.7429974814908541414" to i8*
  ...
  %".34" = bitcast [24 x i8]* @"str.-1696583040775164703" to i8*
...
then:
  %".1718" = bitcast [7 x i8]* @"str.-3814276296837737567" to i8*
  %".1719" = bitcast [4 x i8]* @"fmt_string" to i8*
  %".1720" = call i32 (i8*, ...) @"printf"(i8* %".1719", i8* %".1718")
  br label %"ifcont"
else:
  %".1722" = bitcast [11 x i8]* @"str.-8500427329205055830" to i8*
