...
define i32 @"bubbleSort"(i32 %".1", i32 %".2", i32 %".3")
{
entry:
  %"a" = alloca i32
  store i32 %".1", i32* %"a"
...
ifcont:
  %"b.3" = load i32, i32* %"b"
  %"c.1" = load i32, i32* %"c"
  %".15" = icmp sgt i32 %"b.3", %"c.1"
  br i1 %".15", label %"then.1", label %"else.1"
then.1:
  %"tmp.2" = alloca i32
  %"b.4" = load i32, i32* %"b"
  store i32 %"b.4", i32* %"tmp.2"
  %"c.2" = load i32, i32* %"c"
  store i32 %"c.2", i32* %"b"
...
ifcont.1:
  %"a.3" = load i32, i32* %"a"
  %"b.5" = load i32, i32* %"b"
  %".22" = icmp sgt i32 %"a.3", %"b.5"
  br i1 %".22", label %"then.2", label %"else.2"
then.2:
  %"tmp.4" = alloca i32
  %"a.4" = load i32, i32* %"a"
  store i32 %"a.4", i32* %"tmp.4"
  %"b.6" = load i32, i32* %"b"
  store i32 %"b.6", i32* %"a"
  %"tmp.5" = load i32, i32* %"tmp.4"
  store i32 %"tmp.5", i32* %"b"
  br label %"ifcont.2"
else.2:
  br label %"ifcont.2"
ifcont.2:
...
entry:
  ...
  %"c" = alloca i32
  store i32 2, i32* %"c"
  %".5" = bitcast [13 x i8]* @"str.1729602204818254579" to i8*
  %".6" = bitcast [4 x i8]* @"fmt_string" to i8*
  %".7" = call i32 (i8*, ...) @"printf"(i8* %".6", i8* %".5")
  %"a.1" = load i32, i32* %"a"
  %"b.1" = load i32, i32* %"b"
  %"c.1" = load i32, i32* %"c"
  %".8" = call i32 @"bubbleSort"(i32 %"a.1", i32 %"b.1", i32 %"c.1")
  ret i32 0
}
